...
const HomeBottomText = () => {
  ...
  return (
    <div className='font-[font2] flex items-center justify-center gap-16 '>
      ...
      <div className='lg:border-3 border-2 hover:border-[#D3FD50] hover:text-[#D3FD50] flex items-center border-white rounded-full uppercase  px-8 py-2'>
        <Link className='text-[4vw] lg:mt-4' to='/projects'>Projects</Link>
      </div>


      <div className='lg:border-3 border-2 hover:border-[#D3FD50] hover:text-[#D3FD50] flex items-center px-8 py-2 border-white rounded-full uppercase'>
