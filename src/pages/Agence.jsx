...
const Agence = () => {
  ...
  const imageArray = [
    ...
    'https://i.ibb.co.com/tQjsrC3/1000017694.jpg',
    'https://i.ibb.co.com/hd4m7Yp/carousel1.jpg',
    'https://i.ibb.co.com/rmMy6Pg/Screenshot-21.png',
    'https://i.ibb.co.com/T8jJ6S8/Screenshot-24.png',
    'https://i.ibb.co.com/B6HgJjz/Screenshot-17.png',
    ...
    <div className='parent'>
      <div id='page1' className='py-1 '>
        <div ref={imageDivRef} className='absolute overflow-hidden lg:h-[20vw] h-[30vw] lg:rounded-3xl rounded-xl lg:w-[15vw] w-[25vw] lg:top-40 -top-20 lg:left-[30vw] left-[30vw]'>
          <img ref={imageRef} className='h-full object-cover w-full' src="https://i.ibb.co.com/B6HgJjz/Screenshot-17.png" alt="" />
        </div>
